...
d2=d2.drop_duplicates(subset=["COD_PROD","fecha_stata","RUC"])
d1 = d1.merge(df[["COD_PROD","RUC_mayorista","ID_DIR"]], on=["COD_PROD","ID_DIR"],how="left",indicator=True)
...
#d1.head()
d1x = d1[["COD_PROD","fecha_stata","RUC_mayorista"]].merge(d2[["COD_PROD","fecha_stata","RUC_mayorista","PRECIOVENTA_may"]],on=["RUC_mayorista","fecha_stata","COD_PROD"],how="left")
#d1.loc[d1["_merge"]=="both","Tipo"] = "Provincia misma"
d1[["COD_PROD","fecha_stata","RUC_mayorista"]].tail()
#d1x.tail(20)
