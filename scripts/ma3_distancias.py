...
for k in cod_prods:
    try:
        ...
        data2__.drop_duplicates(subset="RUC",inplace=True)
        data2__=data2.merge(data2__[["RUC","PRECIOVENTA"]],how="inner")
        data2__.drop(["PRECIOVENTA"],axis=1,inplace=True)
        data1__ = data1_.loc[data1_["COD_PROD"]==48]
        ...
        d1d2__ = np.argmin(d1d2, axis=1)
        data1__["id"] = d1d2__
        data1__["COD_PROD"] = k
        data1__ = data1__.merge(data2__[["RUC","id"]],on="id")
